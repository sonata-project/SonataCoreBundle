...
class Colors
{
     ...
     * @return array
     */
    public static function getAll($isInverted = true)
    {
        $colors = array(
        ...
        if ($isInverted) {
            @trigger_error(
                'The $isInverted argument of '.__METHOD__.' is deprecated since 3.3, to be removed in 4.0.',
                E_USER_DEPRECATED
            );
            $colors['fuchsia'] = self::FUCHSIA;
            $colors['aqua'] = self::AQUA;
